	  ...
	  <span></span><img src="images/about-img.png" alt=""><span></span>
	   ...
	   <div class="container">		  
		 ...
		 <div class="col-md-4 about-grids">
			 ...
			 <p>Vacation is a time to relax in safe surroundings.For emergency aid of any kind, call 100 from any phone... </p>
             <div align="right"><a href="#"><!--<input type="button" value="Read More" name="sbmt" />--></a></div> 
		 </div>
	 </div>
</div>
<!--/About-->
...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
	      ...
	      <ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			...
			<li><span class="filter" data-filter="app">Purchase and Leisure</span></li>
			<li><span class="filter" data-filter="card">Divine Touch</span></li>
			<li><span class="filter" data-filter="icon">History Walk</span></li>
			<li><span class="filter" data-filter="fun">Blue lagoon</span></li>
	        </ul>
...
<?php }?>
	...
	<div class="col-md-3 image-grid">
					 <img src="C:\xampp\htdocs\TravelEdited\Travel\Admin\addverimages/<?php echo $data[3]; ?>" width="300px" height="150px" >
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">Globe Trotter</h4>
						...
						<h5 style="color:#000"><span class="img2"></span><a href="#">support[at]globetrotter.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Marquise towers, Lower Parel, Mumbai.</h5>
                        <br/>
                       <img src="images/contac.png" />
                      </div>
